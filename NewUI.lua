...
local aa = {
    function()
        ...
        local w = u("ScreenGui", {Parent = i:IsStudio() and j.PlayerGui or gethui()})
        v(w)
        t:Init(w)
        local x = {
            Version = "1.1.0",
        ...
        function x.CreateWindow(C, D)
            ...
            table.insert(getgenv().SaveTextTrans,D.Title)
    ...
    [20] = function()
        spawn(function()
            ...
            function l.New(m, n)
                ...
                table.insert(getgenv().SaveTextTrans,n.Title)
    ...
    [21] = function()
        ...
        function u.New(v, w, x)
            ...
            table.insert(getgenv().SaveTextTrans,x.Title)
    ...
    [23] = function()
        ...
        function c.New(d, e, f)
            local g = d.Library
            table.insert(getgenv().SaveTextTrans,f.Title)
